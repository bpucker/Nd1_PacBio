...
def construct_dot_plot( self_blast_results, other_blast_results, output_figure, show_status ):
	...
	ax.set_xlabel( "Nd-1 FALCON [Gbp]" )
	ax.set_ylabel( "Nd-1 Canu [Gbp]" )
...
def main( arguments ):
	...
	output_figure = prefix + "dot_plot_heatmap2.png"
	seq_ref_file1 = prefix + "seq1.fasta"
	seq_ref_file2 = prefix + "seq2.fasta"
	...
	construct_dot_plot( self_blast_results, other_blast_results, output_figure, show_status )
